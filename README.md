...
🚧 Early scaffold. Milestones 1–8 (data pipeline, form analysis, basic ILP
optimizer, injury risk, stock-market layer, risk-adjusted optimizer, player
similarity finder, FastAPI backend) are in place; only the frontend dashboard
is left.
...
# interactive docs at /docs (Swagger) and /redoc — auto-generated by FastAPI
```
